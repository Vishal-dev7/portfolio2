...
const Home = () => {
  ...
  return (
    <div id="home" className="text-white relative">
      ...
      <div
        ref={vantaRef}
        className=" top-0 left-0 w-full h-full -z-10 fixed"
      ></div>
      <Navbar />

     
   <section class="grid grid-cols-1 sm:grid-cols-2 pt-3 pb-8 ">
...
I specialize in building fast, responsive, and user-friendly web experiences.</p>
    <button class="bg-gradient-to-r from-purple-600 to-red-500 border px-11 mt-2 text-white py-2 rounded-tr-2xl rounded-bl-2xl shadow-gray-700 shadow-md 2xl:ml-0 2xl:mt-4 border-none  2xl:px-20 2xl:py-5 2xl:text-2xl "><a href="heroImage.jpg" download>Download CV</a></button>
